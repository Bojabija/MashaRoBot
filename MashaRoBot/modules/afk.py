...
def afk(update: Update, context: CallbackContext):
    ...
    if len(args) >= 2:
        ...
        if len(reason) > 100:
            reason = reason[:100]
            notice = "\nAlasan AFK hanya boleh 100 karakter."
    else:
        reason = ""
    ...
    try:
        update.effective_message.reply_text("📴 {} sekarang AFK ‼️{}".format(fname, notice))
    except BadRequest:
        pass
    ...
    if res:
        ...
        try:
            options = [
                "✅ {} telah aktif ‼️",
                "🔥 {} sudah kembali ‼️",
                "✅ {} sekarang berada dalam percakapan ‼️",
                "🔥 {} muncul kembali ‼️",
                "📱 {} kembali aktif ‼️",
                "🔥 {} akhirnya muncul lagi‼️",
